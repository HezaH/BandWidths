...
class Env:
    ...
    def step(self, graph, centrality_values, cent_str):
        melhor_custo = float('inf')
        k = 0
        for _ in range(5):
            custo_s = centrality_heuristic(graph=graph, centrality_values=centrality_values, cent_str=cent_str, alpha=0.3, iter_max=3)
